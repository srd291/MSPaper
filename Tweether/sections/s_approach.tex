...
\begin{center}
$\begin{array}{c}
\includegraphics[width=0.8\linewidth]{sentiment_t1} \\
\mbox{\small{(a)}} \\
\includegraphics[width=0.8\linewidth]{sentiment_t2} \\
\mbox{\small{(b)}}
\end{array}$
\end{center}
\vspace{-.1in}
...
\includegraphics[width=0.2\linewidth]{sample} &
\includegraphics[width=0.2\linewidth]{sample} &
\includegraphics[width=0.2\linewidth]{sample}
\\
