...
The mass majority of clustering visualizations uses k-means clustering on the basis of their algorithms~\cite{li2014nasty,weber2001visualizing}. We choose to follow this pattern as well. \pin{The user's dilemma of what clustering information is needed provides insight as to why k-means is widely chosen; primarily due to it being a simple clustering algorithm~\cite{weber2001visualizing}.}
