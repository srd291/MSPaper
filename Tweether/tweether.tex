...
%% Uncomment below to include a teaser figure.
   ...
   \teaser{
   \centering
%   \includegraphics[height=2.5cm]{morning.png}
%   \includegraphics[height=2.5cm]{afternoon.png}
%   \includegraphics[height=2.5cm]{night3.png}
\includegraphics[width=1.0\linewidth]{ppp.png}
