...
\begin{figure}[t]
 \centering
 \includegraphics[width=1.0\linewidth]{ppp}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.75\linewidth]{wk1-real_cr.png} \\
\mbox{\small{(a)}}\\
\includegraphics[width=0.75\linewidth]{wk2-real_cr.png} \\
\mbox{\small{(b)}}
\end{center}
\vspace{-.1in}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.6\linewidth]{chart1} \\
\mbox{\small{(a)}}\\
\includegraphics[width=0.6\linewidth]{chart2} \\
\mbox{\small{(b)}}\\
\includegraphics[width=0.6\linewidth]{chart3} \\
\mbox{\small{(c)}}
\end{center}
\vspace{-.1in}
...
\subsection{Weather Related Tweets}
...
Method 2 & 26\% & 28\% \\ \hline
Method 3 & 23\% & 26\% \\ \hline
\end{tabular}}
\end{center}
\vspace{-.2in}
\label{tab:err}
